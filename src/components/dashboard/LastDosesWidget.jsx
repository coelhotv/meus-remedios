  ...
  if (isLoading) {
    return (
      <div className="last-doses-widget last-doses-widget--loading">
        <div className="last-doses-widget__header">
          <h3 className="last-doses-widget__title">Últimas Doses</h3>
        </div>
  ...
  return (
    <div className="last-doses-widget">
      <div className="last-doses-widget__header">
        <h3 className="last-doses-widget__title">Últimas Doses</h3>
        {lastDoses.length > 0 && (
          <span className="last-doses-widget__count">{lastDoses.length}</span>
        )}
      </div>
      ...
      {lastDoses.length === 0 ? (
        <div className="last-doses-widget__empty">
          ...
          <button className="last-doses-widget__empty-action" onClick={onViewHistory}>
