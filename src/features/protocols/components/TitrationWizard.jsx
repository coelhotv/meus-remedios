    ...
    <div className="titration-wizard">
          ...
          <div className="input-group">
            ...
            <div className="input-with-suffix">
              <input 
                ...
                onChange={(e) => setCurrentStage(prev => ({ ...prev, days: parseInt(e.target.value) }))}
              />
              <span>dias</span>
            </div>
          </div>
          ...
          <div className="input-group">
            ...
            <div className="input-with-suffix">
              <input 
                ...
                onChange={(e) => setCurrentStage(prev => ({ ...prev, dosage: parseFloat(e.target.value) }))}
              />
              <span>comp.</span>
            </div>
          </div>
      ...
      {stages.length > 0 && (
        <div className="titration-summary">
          <span>⏱️ Tempo total previsto: <strong>{totalDays} dias</strong> até a manutenção.</span>
        </div>
      )}
    </div>
  )
