---
id: ADR-026
title: Web Permanece na Raiz nas Fases 0-6
status: accepted
date: 2026-04-10
tags:
  - architecture
  ...
  - hybrid
  - phases
context: Hybrid web+native architecture evolution spans 7 phases. Moving web from ./ to apps/web/ early causes Vercel regressions, refactoring friction, and parallel conflicts.
decision: Web remains at root during Phases 0-6 (Guardrails → Push + Beta). Move to apps/web/ only if Phase 7 (optional monorepo) is executed.
source_pr: 457
supersedes: None
superseded_by: None
---

# ADR-026 — Web Permanece na Raiz nas Fases 0-6
...
- **Apendice A (Decisoes congeladas):** Listar este ADR como D-026.
