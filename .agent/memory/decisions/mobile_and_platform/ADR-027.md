---
id: ADR-027
title: Tabela Dedicada notification_devices para Tokens
status: accepted
date: 2026-04-10
tags:
  - database
  ...
  - notifications
  - privacy
context: Mobile app (Phase 6) needs to support push notifications. Device tokens are sensitive, temporary, and multiple per user.
decision: Create dedicated notification_devices table (M:1 relationship) instead of storing tokens in profiles. Schema includes expo_push_token, apns_identifier, fcm_token with is_active flag.
source_pr: 457
supersedes: None
superseded_by: None
---

# ADR-027 — Tabela Dedicada `notification_devices` para Tokens
